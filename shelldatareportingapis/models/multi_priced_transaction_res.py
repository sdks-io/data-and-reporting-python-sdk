...
class MultiPricedTransactionRes(object):

    """Implementation of the 'MultiPricedTransactionRes' model.
    ...
    Attributes:
        ...
        data (List[MultiPricedTransactionResponse]): The model property of
            type List[MultiPricedTransactionResponse].
    ...
    def __init__(self,
        ...
        """Constructor for the MultiPricedTransactionRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [MultiPricedTransactionResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

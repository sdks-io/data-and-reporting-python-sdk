...
class VolumeBasedPricingRes(object):

    """Implementation of the 'VolumeBasedPricingRes' model.
    ...
    Attributes:
        ...
        data (List[VolumeBasedPricingResponse]): The model property of type
            List[VolumeBasedPricingResponse].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the VolumeBasedPricingRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [VolumeBasedPricingResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

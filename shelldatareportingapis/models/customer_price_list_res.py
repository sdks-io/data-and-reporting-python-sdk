...
class CustomerPriceListRes(object):

    """Implementation of the 'CustomerPriceListRes' model.
    ...
    Attributes:
        ...
        data (List[CustomerPriceListResponse]): The model property of type
            List[CustomerPriceListResponse].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CustomerPriceListRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [CustomerPriceListResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

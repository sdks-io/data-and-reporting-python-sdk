...
class AccountReq(object):

    """Implementation of the 'AccountReq' model.

    Attributes:
        filters (AccountRequest): The model property of type AccountRequest.
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the AccountReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = AccountRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

...
class AccountRes(object):

    """Implementation of the 'AccountRes' model.
    ...
    Attributes:
        ...
        data (List[AccountResponseAccountsItems]): The model property of type
            List[AccountResponseAccountsItems].
    ...
    def __init__(self,
        ...
        """Constructor for the AccountRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [AccountResponseAccountsItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

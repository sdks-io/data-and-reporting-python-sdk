...
class PricedTransactionRes(object):

    """Implementation of the 'PricedTransactionRes' model.
    ...
    Attributes:
        ...
        data (List[PricedTransactionResponse]): The model property of type
            List[PricedTransactionResponse].
    ...
    def __init__(self,
        ...
        """Constructor for the PricedTransactionRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [PricedTransactionResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

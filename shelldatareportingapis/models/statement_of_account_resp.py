...
from shelldatareportingapis.models.last_statement_of_account_2 import LastStatementOfAccount2
...
class StatementOfAccountResp(object):
    ...
    Attributes:
        last_statement_of_account (LastStatementOfAccount2): The model
            property of type LastStatementOfAccount2.
    ...
    def from_dictionary(cls,
        ...
        last_statement_of_account = LastStatementOfAccount2.from_dictionary(dictionary.get('LastStatementOfAccount')) if 'LastStatementOfAccount' in dictionary.keys() else APIHelper.SKIP

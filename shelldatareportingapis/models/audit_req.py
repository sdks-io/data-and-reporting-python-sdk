...
class AuditReq(object):

    """Implementation of the 'AuditReq' model.

    Attributes:
        filters (AuditRequest): The model property of type AuditRequest.
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the AuditReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = AuditRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

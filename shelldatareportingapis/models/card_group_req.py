...
class CardGroupReq(object):

    """Implementation of the 'CardGroupReq' model.

    Attributes:
        filters (CardGroupRequest): The model property of type
            CardGroupRequest.
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the CardGroupReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = CardGroupRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

...
class PricedResponseData(object):
    ...
    Attributes:
        ...
        col_co_code (str): Collecting Company Code (Shell Code) of the
            selected payer.
        unit_discount_invoice_currency (float): Unit discount Invoice
            currency
        ...
        customer_currency_code (str): Curreny which customer uses to
            transact.
        ...
        unit_price_in_invoice_currency (float): Unitpricing in invoice
            currency
        ...
        credit_debit_code (str): Is it Credit or debit C for credit D for
            Debit

...
class CardGroupRes(object):

    """Implementation of the 'CardGroupRes' model.
    ...
    Attributes:
        ...
        data (List[CardGroupResponseCardGroupsItems]): The model property of
            type List[CardGroupResponseCardGroupsItems].
    ...
    def __init__(self,
        ...
        """Constructor for the CardGroupRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [CardGroupResponseCardGroupsItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

...
class LoggedInUserRes(object):

    """Implementation of the 'LoggedInUserRes' model.
    ...
    Attributes:
        ...
        data (List[LoggedInUserResponse]): The model property of type
            List[LoggedInUserResponse].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the LoggedInUserRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [LoggedInUserResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

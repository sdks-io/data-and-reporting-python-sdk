...
class MultiPricedTransactionReq(object):

    """Implementation of the 'MultiPricedTransactionReq' model.

    Attributes:
        filters (MultiPricedTransactionRequest): The model property of type
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the MultiPricedTransactionReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = MultiPricedTransactionRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

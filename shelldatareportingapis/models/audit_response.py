...
from shelldatareportingapis.models.audit_array_elements import AuditArrayElements
...
class AuditResponse(object):
    ...
    Attributes:
        ...
        data (List[AuditArrayElements]): The model property of type
            List[AuditArrayElements].
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [AuditArrayElements.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

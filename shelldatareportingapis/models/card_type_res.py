...
class CardTypeRes(object):

    """Implementation of the 'CardTypeRes' model.
    ...
    Attributes:
        ...
        data (List[CardTypeResponseCustomerCardTypesItems]): The model
            property of type List[CardTypeResponseCustomerCardTypesItems].
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CardTypeRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [CardTypeResponseCustomerCardTypesItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

...
class PricedTransSummaryResp(object):

    """Implementation of the 'PricedTransSummaryResp' model.
    ...
    Attributes:
        ...
        data (List[PricedTransSummaryResponseTransactionsSummaryItems]): The
    ...
    def __init__(self,
        ...
        """Constructor for the PricedTransSummaryResp class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [PricedTransSummaryResponseTransactionsSummaryItems.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
        warnings = None

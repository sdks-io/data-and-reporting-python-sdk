...
class CardUsageSummaryRes(object):

    """Implementation of the 'CardUsageSummaryRes' model.
    ...
    Attributes:
        ...
        data (List[CardUsageSummaryResponse]): The model property of type
            List[CardUsageSummaryResponse].
    ...
    def __init__(self,
        ...
        """Constructor for the CardUsageSummaryRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [CardUsageSummaryResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
        warnings = None

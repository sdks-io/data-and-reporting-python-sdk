...
class PayerRes(object):

    """Implementation of the 'PayerRes' model.
    ...
    Attributes:
        ...
        data (List[PayerDetails]): The model property of type
            List[PayerDetails].
    ...
    def __init__(self,
        ...
        """Constructor for the PayerRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [PayerDetails.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

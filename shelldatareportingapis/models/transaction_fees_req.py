...
class TransactionFeesReq(object):

    """Implementation of the 'TransactionFeesReq' model.

    Attributes:
        filters (TransactionFeesRequest): The model property of type
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the TransactionFeesReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = TransactionFeesRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

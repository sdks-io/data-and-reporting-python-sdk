...
class PriceTransactionRequest(object):
    ...
    Attributes:
        ...
        sort_order (str): Allowed Sorting Options: 1.   
            ...
            considered) 6.    DriverNameDescending (If Driver Name is null
            then VRN value will be considered) 7.    VRNAscending (If VRN is
            null then Driver Name value will be considered) 8.   
            VRNDescending (If VRN is null then Driver Name value will be
            considered) 9.    NetAmountAscending 10.    NetAmountDescensding
        ...
        use_field_id (bool): True/False Optional Default value – False. When
            ...
            Field IDs. This will reduce the output payload size significantly
            for large data sets and help faster transmission of data over
            networks.

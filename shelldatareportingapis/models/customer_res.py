...
class CustomerRes(object):

    """Implementation of the 'CustomerRes' model.
    ...
    Attributes:
        ...
        data (List[CustomerDetailResponse]): The model property of type
    ...
    def __init__(self,
                 ...
                 data=APIHelper.SKIP):
        """Constructor for the CustomerRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [CustomerDetailResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP

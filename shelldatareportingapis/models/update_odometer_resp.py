...
class UpdateOdometerResp(object):

    """Implementation of the 'UpdateOdometerResp' model.
    ...
    Attributes:
        ...
        data (List[UpdateOdometerResponse]): The model property of type
            List[UpdateOdometerResponse].
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateOdometerResp class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [UpdateOdometerResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
        warnings = None

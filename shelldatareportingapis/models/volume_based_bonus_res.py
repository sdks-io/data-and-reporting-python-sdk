...
class VolumeBasedBonusRes(object):

    """Implementation of the 'VolumeBasedBonusRes' model.
    ...
    Attributes:
        ...
        data (List[VolumeBasedBonusResponse]): The model property of type
            List[VolumeBasedBonusResponse].
    ...
    def __init__(self,
        ...
        """Constructor for the VolumeBasedBonusRes class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [VolumeBasedBonusResponse.from_dictionary(x) for x in dictionary.get('Data')]
        else:
            data = APIHelper.SKIP
        warnings = None

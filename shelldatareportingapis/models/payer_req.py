...
class PayerReq(object):

    """Implementation of the 'PayerReq' model.

    Attributes:
        filters (PayerRequest): The model property of type PayerRequest.
    ...
    def __init__(self,
                 ...
                 page=1,
                 page_size=50):
        """Constructor for the PayerReq class"""
    ...
    def from_dictionary(cls,
        ...
        filters = PayerRequest.from_dictionary(dictionary.get('Filters')) if 'Filters' in dictionary.keys() else APIHelper.SKIP

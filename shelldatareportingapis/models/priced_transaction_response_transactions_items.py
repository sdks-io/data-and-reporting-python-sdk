...
class PricedTransactionResponseTransactionsItems(object):
    ...
    Attributes:
        ...
        site_name (str): Site Name Example: 050001 -    CHARNOCK RICHARD
            NTHBOUND MWSA 0755 050002 -    CHARNOCK RICHARD STHBOUND MWSA 0755
        site_country (str): Site Country Example: France, Germany Note: - The
            value could be null/blank for fees item. Geography Location entity
            for Site Location Note: - The value could be null/blank for fees
            item.
        location (List[object | None | PricedTransactionItemsLocationItems] |
            None): Geography Location entity for Site Location Note: - The
        ...
        network (str): Network as configured in GFN (Shell PH, ESSO, etc.,)
            100013    STEINDORFER 100015    S.A. BELGIAN SHELL N.V. 100016   
            ESSO BE Note: - The value could be null/blank for fees item
        ...
        authorisation_code (str): Authorisation code of the transaction
            Example: 011256 Note: - The value could be null/blank for fees item
        ...
        dispute_status (str): Sales Item Dispute Status if disputed 0    No
            ...
            to Site Note: - The value could be null/blank for fees item.
        ...
        del_co_to_col_co_exchange_rate (float): Exchange rate from transaction
            currency to customer currency. Example: 1 Note: - The value could
            be null/blank for fees item
        net_euro_amount (float): Net euro amount. Example: 37.93 Note: - The
            value could be null/blank for fees item
        euro_rebate_amount (float): Euro rebate amount. Example: 0 Note: - The
            value could be null/blank for fees item
    ...
    def from_dictionary(cls,
        ...
        """
        from shelldatareportingapis.utilities.union_type_lookup import UnionTypeLookUp
        ...
        location = APIHelper.deserialize_union_type(UnionTypeLookUp.get('PricedTransactionResponseTransactionsItemsLocation'), dictionary.get('Location'), False) if dictionary.get('Location') is not None else APIHelper.SKIP

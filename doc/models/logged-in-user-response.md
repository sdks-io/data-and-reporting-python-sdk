...
| `is_super_admin` | `bool` | Optional | Whether the user is a super administrator<br>**Default**: `False` |
...
| `display_week` | `bool` | Optional | Preferred Display Week on Fuel Prices configuration for the logged in User.<br>**Default**: `True` |
...
| `has_api_access` | `bool` | Optional | True/False<br>True, if user has access to the requested API. This is validated based on the role Vs API access matrix and client Vs API access matrix.<br>**Default**: `True` |
